...
// 描画関数
//*****************************************************************************
void CScene2D::DrawUIRender(void)
{
	// 自動描画ONなら
	if(m_AutoDraw)
	{
...
// Xの頂点座標を変更する
//*****************************************************************************
void CScene2D::SetVertexPolygonX(float x)
{
	m_Pos.x = x;
	...
	//--------------------------------------------------------------------------------
	//描画したい頂点座標の設定(座標はZ字またはN字順に設定する)
	pVtx[0].vtx.x = m_Pos.x - m_fWidth * 0.5f;
	pVtx[1].vtx.x = m_Pos.x + m_fWidth * 0.5f;
	pVtx[2].vtx.x = m_Pos.x - m_fWidth * 0.5f;
	pVtx[3].vtx.x = m_Pos.x + m_fWidth * 0.5f;
	m_pD3DVtxBuff->Unlock();									// ロックしたら必ずアンロック！！
	//********************************************************************************************************************
}
...
// Yの頂点座標を変更する
//*****************************************************************************
void CScene2D::SetVertexPolygonY(float y)
{
	m_Pos.y = y;
	...
	//--------------------------------------------------------------------------------
	//描画したい頂点座標の設定(座標はZ字またはN字順に設定する)
	pVtx[0].vtx.y = m_Pos.y - m_fHeight * 0.5f;
	pVtx[1].vtx.y = m_Pos.y - m_fHeight * 0.5f;
	pVtx[2].vtx.y = m_Pos.y + m_fHeight * 0.5f;
	pVtx[3].vtx.y = m_Pos.y + m_fHeight * 0.5f;
	m_pD3DVtxBuff->Unlock();									// ロックしたら必ずアンロック！！
	//********************************************************************************************************************
}
...
// 左右の値しか変更しないVER
//*****************************************************************************
void	CScene2D::SetUV(float l, float r)
{
	VERTEX_2D *pVtx;
	//********************************************************************************************************************
	//ポリゴンの設定
...
void CScene2D::SetUV(D3DXVECTOR2 pUVIndex[4])
{
	VERTEX_2D *pVtx;
	//********************************************************************************************************************
	//ポリゴンの設定
	...
	pVtx[0].tex = pUVIndex[0];
	pVtx[1].tex = pUVIndex[1];
	pVtx[2].tex = pUVIndex[2];
	pVtx[3].tex = pUVIndex[3];
