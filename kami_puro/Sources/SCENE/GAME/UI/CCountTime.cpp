...
// コンストラクタ
//=============================================================================
CCountTime::CCountTime(LPDIRECT3DDEVICE9 *pDevice, CManager *pManager)
{
	m_pManager = pManager;
	m_pGame = (CGame*)(m_pManager->GetPhase());
...
{
	CCountTime* p = new CCountTime(pDevice, pManager);
	p->Init(pos, time);
	return p;
}
