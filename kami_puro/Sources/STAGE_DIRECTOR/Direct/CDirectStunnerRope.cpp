//=============================================================================
//
// CDirectStunnerRopeクラス [CDirectStunnerRope.cpp]
// Author : 池島　大樹
//
//=============================================================================
...
const int STUNNER_DAMAGE2 = (int)( 120 * DAMAGE_AMP * 1.5f );
const int STUNNER_TENSION = (int)( 10 * TENSION_AMP * 1.5f );

//=================================================
// コンストラクタ
//=================================================
CDirectStunnerRope::CDirectStunnerRope( CManager *pManager, CGame *pGame ) : CDirect( pManager, pGame )
{
...
// デストラクタ
//=================================================
CDirectStunnerRope::~CDirectStunnerRope( void )
{
...
// 初期化
//=================================================
void CDirectStunnerRope::Init( PLAYER_ID playerID )
{
	m_FrameCount = 0;		// 固定
...
// 終了
//=================================================
void CDirectStunnerRope::Uninit( void )
{
