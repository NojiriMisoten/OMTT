//=============================================================================
//
// CDirectDropkickRopeクラス [CDirectDropkickRope.cpp]
// Author : 池島　大樹
//
//=============================================================================
...
const int DROPKICK_DAMAGE = (int)( 120 * DAMAGE_AMP * 1.5f );
const int DROPKICK_TENSION = (int)( 10 * TENSION_AMP * 1.5f );

//=================================================
// コンストラクタ
//=================================================
CDirectDropkickRope::CDirectDropkickRope(CManager *pManager, CGame *pGame ) : CDirect( pManager, pGame )
{
...
// デストラクタ
//=================================================
CDirectDropkickRope::~CDirectDropkickRope( void )
{
...
// 初期化
//=================================================
void CDirectDropkickRope::Init( PLAYER_ID playerID )
{
	m_FrameCount = 0;		// 固定
...
// 終了
//=================================================
void CDirectDropkickRope::Uninit( void )
{
...
// 更新
//=================================================
void CDirectDropkickRope::Update( void )
{
	D3DXVECTOR3 pos[2] = {
